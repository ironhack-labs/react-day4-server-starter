...
app.use(session({secret: "some secret goes here", resave: true, saveUninitialized: true}));
...
app.use(cors({
    credentials: true, origin: ['http://localhost:3000'] // <== this will be the URL of our React app (it will be running on port 3000)
}));
